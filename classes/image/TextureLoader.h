...
public:
	MTextureLoader();
	~MTextureLoader();
	stTexture* LoadTexture(const char* inFileName, unsigned int CountX, unsigned int CountY, unsigned int CountToRead, unsigned int& ReturnCount, float inFilterType, float inWrapType, bool UseAtlas);
